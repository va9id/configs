...
You can modify what fields are fetched from Jira in [fetchJiraTicketFields.js](/obsidian/templater/user%20functions/fetchJiraTicketFields.js) by modifying the query parameters
